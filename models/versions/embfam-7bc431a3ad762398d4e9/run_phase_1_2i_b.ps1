param(
    ...
    [string]$DiagnosticRun = "F:\sohail\Class_Attendance_YuNet_SFace\attendance_output\diagnostics\2026-06-30__B51__P2__CVO_20260712_221105_286649",
    [string]$FamilyId = "",
...
$DiagnosticRun = (Resolve-Path -LiteralPath $DiagnosticRun).Path
...
Write-Host "Diagnostic run: $DiagnosticRun"
...
try {
    ...
    Invoke-CheckedPython -Stage "Immutable recovery-bundle verification" -Arguments @(
        ...
        "--diagnostic-run-dir", $DiagnosticRun
    ) | Out-Null
