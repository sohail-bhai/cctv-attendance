...
Embedding outliers available in broad source: 12
Embedding outliers selected: 12

## Source availability exception

The following stored outlier is not present in the validated 855-item broad package. It was considered but cannot be added without breaking immutable-source subset accounting:

- `dataset\2401100CSE0140 (C) Shruthi\WhatsApp Image 2026-06-23 at 18.58.21.jpeg` (2401100CSE0140; robust score 4.798318)
