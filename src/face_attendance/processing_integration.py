...
POLICY_VERSION = "product-phase-2i-strict-tracklet-authority-v1"
...
def build_processing_command(
    *,
    ...
    if policy.get("tracklets_used_for_official_attendance") is not True:
        raise ProcessingIntegrationError("Strict tracklets must remain the official authority in Phase 2I")
