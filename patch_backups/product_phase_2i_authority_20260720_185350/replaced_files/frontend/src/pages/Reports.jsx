            ...
            {savedSessionPreview.map((session) => (
              <article key={session.session_id} style={merge(S.savedCard, loadedSession?.session_id === session.session_id && { borderColor: '#0f8b8d', boxShadow: '0 15px 32px rgba(15, 139, 141, 0.13)' })}>
                ...
                <div style={S.savedMeta}>
                  ...
                  <span>•</span>
                  <span>{session.unresolved_count || 0} review</span>
                </div>
                <div style={S.actions}>
      ...
      {hasReport && cleanSlot && (
        <section style={S.card}>
          ...
          <div style={S.metricGrid}>
            ...
            <MetricCard label="Need review" value={attendanceSummary.review} hint={reportQuality.requiresManualReview ? 'Manual review required' : 'Doubtful / flagged'} tone="warning" />
